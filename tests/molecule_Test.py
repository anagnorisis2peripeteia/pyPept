...
class TestMolecule(unittest.TestCase):
    ...
    def test_get_molecule(self):
        ...
        self.assertEqual(try_get_molecule('C.!1(4,4)-A-A-A-C.!1(4,4)'),
        ...
        self.assertEqual(try_get_molecule('ac-D-T-H-F-E-I-A-am'),
                         'CC[C@H](C)[C@H](NC(=O)[C@H](CCC(=O)O)NC(=O)[C@H](Cc1ccccc1)NC(=O)'
                         '[C@H](Cc1cnc[nH]1)NC(=O)[C@@H](NC(=O)[C@H](CC(=O)O)NC(C)=O)[C@H](C)O)'
                         'C(=O)N[C@@H](C)C(N)=O')
        self.assertEqual(try_get_molecule('A-A-D.!1(4,4)-A-A-K.!2(4,4)-A-A.K.!1(4,4)-A-A-D.!2(4,4)'),
        ...
        self.assertEqual(try_get_molecule('A-G-Q-A-A-K.!1(4,4)-E-F-I-A-A.G-L-E-E.!1(4,4)'),
